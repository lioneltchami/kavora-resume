...
const leadFeature = {
  title: "One slug. Two public pages.",
  description:
    "Publish kavoraresume.cv/r/you for recruiters and /p/you for projects and contact — same account, same name. Tailor for a job, share, download PDF.",
};
...
export default function LandingPage() {
  return (
    <SiteChrome>
      {/* Marquee fold — brand + one product line; CTA below rule */}
      <section className="marquee-fold" aria-label="Hero">
        <h1 className="marquee-brand">Kavora</h1>
        <p className="marquee-line mt-6 md:mt-8">
          Resume &amp; portfolio. One link.
        </p>
      </section>

      <hr className="rule-thick w-full" />

      {/* Below fold — CTA + proof */}
          ...
          <div className="mt-12">
            <article className="feature-row feature-row--lead">
              ...
              <div>
                ...
                <p className="mt-4 flex flex-wrap gap-x-6 gap-y-2 font-mono text-xs text-accent">
                  <span>/r/you — resume</span>
                  <span>/p/you — portfolio</span>
                </p>
              </div>
            </article>
